...
> (3) **HU-18 portafolio (rama `feat/e3-hu-18`):** cableada a backend real (controller+route+página nuevos,
> semáforo server-side); **pendiente de montaje en `server.js` por Maiki**, por lo que aún NO está en `main`.
>
