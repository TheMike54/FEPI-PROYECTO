...
\restrict k6m4K6YcPZhR3zBmd5EX762HvB0hqHX7j3705h7R4BFfJrUtlpiuQvn8tOahXdW
...
--
-- Name: avance_fotos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.avance_fotos (
    id integer NOT NULL,
...
--
-- Name: avance_fotos_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.avance_fotos_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: avance_fotos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.avance_fotos_id_seq OWNED BY public.avance_fotos.id;
...
--
-- Name: cobro_soportes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cobro_soportes (
    id integer NOT NULL,
    ...
    subido_por integer,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT cobro_soportes_tipo_check CHECK (((tipo)::text = ANY ((ARRAY['cfdi'::character varying, 'oficio'::character varying, 'otro'::character varying])::text[])))
);


--
-- Name: cobro_soportes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cobro_soportes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cobro_soportes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cobro_soportes_id_seq OWNED BY public.cobro_soportes.id;
...
CREATE TABLE public.contratos (
    ...
    contratista_empresa_id integer,
    supervision_empresa_id integer,
...
CREATE TABLE public.estimacion_observaciones (
    ...
    estimacion_generador_id integer,
...
--
-- Name: avance_fotos id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.avance_fotos ALTER COLUMN id SET DEFAULT nextval('public.avance_fotos_id_seq'::regclass);
...
--
-- Name: cobro_soportes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cobro_soportes ALTER COLUMN id SET DEFAULT nextval('public.cobro_soportes_id_seq'::regclass);
...
--
-- Data for Name: avance_fotos; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.avance_fotos (id, avance_id, nombre, descripcion, mime, tamano, contenido, subido_por, created_at) FROM stdin;
\.
...
69	28	avance	Avance de trabajos — Cimentación: se ejecutaron 200 m3 en el periodo 2, conforme al programa de obra. (art. 125 fr. II RLOPSRM; asiento automático del sistema.)	2	2026-06-24 06:43:31.773796+00	2026-06-24 06:43:31.773796+00	2	Avance de trabajos — Cimentación	\N	emitida	2026-06-24 06:43:31.773796+00	avance
70	19	res_convenios	Convenio modificatorio CM-002: plazo; variación 50.00% sobre plazo. Motivo: [Oficio de soporte: 4] holaaaa. (art. 59 LOPSRM / art. 99, 123 fr. XI RLOPSRM; asiento automático del sistema.)	35	2026-06-24 06:48:44.45474+00	2026-06-24 06:48:44.45474+00	7	Convenio modificatorio CM-002 (plazo)	\N	emitida	2026-06-24 06:48:44.45474+00	convenio
71	19	res_convenios	Convenio modificatorio 45646: programa; variación 0.00% sobre monto. Motivo: [Oficio de soporte: klnkj] lknh. (art. 59 LOPSRM / art. 99, 123 fr. XI RLOPSRM; asiento automático del sistema.)	35	2026-06-24 07:00:26.138798+00	2026-06-24 07:00:26.138798+00	8	Convenio modificatorio 45646 (programa)	\N	emitida	2026-06-24 07:00:26.138798+00	convenio
72	19	res_convenios	Convenio modificatorio CM-004: programa; variación 4251.52% sobre monto. Motivo: [Oficio de soporte: k] uijhiu. (art. 59 LOPSRM / art. 99, 123 fr. XI RLOPSRM; asiento automático del sistema.)	35	2026-06-24 07:31:16.617259+00	2026-06-24 07:31:16.617259+00	9	Convenio modificatorio CM-004 (programa)	\N	emitida	2026-06-24 07:31:16.617259+00	convenio
73	18	otro	klml	35	2026-06-24 07:32:40.07206+00	2026-06-24 07:32:40.07206+00	15	kjb	\N	emitida	2026-06-24 07:32:40.07206+00	klm
74	19	res_convenios	Convenio modificatorio kln: monto; variación 0.33% sobre monto. Motivo: [Oficio de soporte: hkjhkj] kjhnkn. (art. 59 LOPSRM / art. 99, 123 fr. XI RLOPSRM; asiento automático del sistema.)	35	2026-06-24 07:41:05.616902+00	2026-06-24 07:41:05.616902+00	10	Convenio modificatorio kln (monto)	\N	emitida	2026-06-24 07:41:05.616902+00	convenio
75	41	avance	Avance de trabajos — sad: se ejecutaron 812 m² en el periodo 1, conforme al programa de obra. (art. 125 fr. II RLOPSRM; asiento automático del sistema.)	2	2026-06-24 07:49:37.355743+00	2026-06-24 07:49:37.355743+00	4	Avance de trabajos — sad	\N	emitida	2026-06-24 07:49:37.355743+00	avance
\.


--
-- Data for Name: cobro_soportes; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.cobro_soportes (id, estimacion_id, tipo, nombre, mime, tamano, contenido, subido_por, created_at) FROM stdin;
\.
...
52	113	113	69	200.000	2026-06-21	knk	2	2026-06-24 06:43:31.773796+00	vigente	\N	\N	\N
53	151	151	75	812.000	2026-06-23	\N	2	2026-06-24 07:49:37.355743+00	vigente	\N	\N	\N
\.
...
COPY public.contrato_conceptos (id, contrato_id, orden, concepto, unidad, cantidad, pu, created_at, clave, es_adicional) FROM stdin;
151	53	1	sad	m²	1312.000	21.0000	2026-06-22 17:05:53.683791+00	sad	f
153	27	4	ads	m3	500.000	46.0000	2026-06-24 07:41:05.616902+00	a01	t
73	26	1	Limpieza y trazo del terreno	m²	1000.000	50.0000	2026-06-21 21:53:40.071664+00	C-01	f
74	26	2	Excavación a máquina	m³	500.000	200.0000	2026-06-21 21:53:40.071664+00	C-02	f
75	26	3	Concreto f’c=200 kg/cm²	m³	300.000	2500.0000	2026-06-21 21:53:40.071664+00	C-03	f
76	26	4	Acero de refuerzo fy=4200	kg	2000.000	50.0000	2026-06-21 21:53:40.071664+00	C-04	f
77	27	1	ads	m³	524.000	45.0000	2026-06-22 01:11:01.623717+00	dsa	f
78	27	2	hgfh	cm	524.000	258.0000	2026-06-22 01:11:01.623717+00	dsf	f
79	28	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
80	28	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
81	28	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
82	29	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
83	29	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
84	29	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
86	30	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
87	30	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
85	30	1	Terracerías y movimiento de tierras	m3	1200.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
88	31	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
89	31	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
90	31	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
91	32	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
92	32	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
93	32	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
94	33	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
95	33	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
96	33	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
97	34	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
98	34	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
99	34	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
100	35	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
101	35	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
102	35	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
103	36	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
104	36	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
105	36	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
106	37	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
107	37	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
108	37	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
109	38	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
110	38	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
111	38	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
112	39	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
113	39	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
114	39	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
115	40	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
116	40	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
117	40	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
118	41	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
119	41	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
120	41	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
121	42	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
122	42	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
123	42	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
124	43	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
125	43	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
126	43	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
127	44	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
128	44	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
129	44	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
130	45	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
131	45	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
132	45	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
133	46	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
134	46	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
135	46	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
136	47	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
137	47	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
138	47	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
139	48	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
140	48	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
141	48	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
142	49	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
143	49	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
144	49	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
145	50	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
146	50	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
147	50	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
148	51	1	Terracerías y movimiento de tierras	m3	1000.000	300.0000	2026-06-22 16:50:13.015179+00	CONC-01	f
149	51	2	Cimentación	m3	200.000	1500.0000	2026-06-22 16:50:13.015179+00	CONC-02	f
150	51	3	Estructura y obra negra	lote	1.000	400000.0000	2026-06-22 16:50:13.015179+00	CONC-03	f
152	27	3	kjnkl	cm3	216.000	31251.0000	2026-06-24 07:31:16.617259+00	jhb	t
\.
...
5	27	observaciones_EST-002_OBRA-2026-PRUEBA-FINAL_2026-06-18.pdf	application/pdf	4089	\\x25	2026-06-24 06:49:50.161962+00	oficio_convenio	5
6	27	reporte_1_avance-fisico_mensual_2026-06-18.pdf	application/pdf	4883	\\x25	2026-06-24 07:31:33.387869+00	oficio_convenio	7
\.
...
76	27	1	2026-06-15	2026-06-20	2026-06-22 01:11:01.623717+00
77	27	2	2026-06-21	2026-06-23	2026-06-22 01:11:01.623717+00
93	32	3	2026-06-22	2026-06-23	2026-06-22 16:50:13.015179+00
151	53	1	2026-06-22	2026-06-23	2026-06-22 17:05:53.683791+00
...
COPY public.contrato_roster (id, contrato_id, rol, usuario_id, vigencia_desde, vigencia_hasta, motivo, sustituye_a, nota_id, registrado_por, created_at, empresa_id) FROM stdin;
152	53	residente	35	2026-06-22	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-22 17:05:53.683791+00	\N
153	53	superintendente	2	2026-06-22	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-22 17:05:53.683791+00	\N
154	53	supervision	3	2026-06-22	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-22 17:05:53.683791+00	\N
73	26	residente	35	2026-01-01	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-21 21:53:40.071664+00	\N
75	26	supervision	3	2026-01-01	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-21 21:53:40.071664+00	\N
74	26	superintendente	2	2026-01-01	2026-06-21	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-21 21:53:40.071664+00	\N
76	26	superintendente	7	2026-06-21	\N	Cambio de superintendente (art. 125 fr. I g RLOPSRM).	74	29	4	2026-06-21 23:26:29.658448+00	\N
77	27	residente	35	2026-06-15	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-22 01:11:01.623717+00	\N
78	27	superintendente	2	2026-06-15	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-22 01:11:01.623717+00	\N
79	27	supervision	22	2026-06-15	\N	Asignación inicial (alta del contrato)	\N	\N	35	2026-06-22 01:11:01.623717+00	\N
80	28	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
81	28	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
82	28	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
83	29	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
84	29	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
85	29	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
86	30	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
87	30	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
88	30	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
89	31	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
90	31	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
91	31	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
92	32	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
93	32	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
94	32	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
95	33	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
96	33	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
97	33	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
98	34	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
99	34	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
100	34	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
101	35	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
102	35	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
103	35	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
104	36	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
105	36	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
106	36	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
107	37	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
108	37	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
109	37	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
110	38	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
111	38	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
112	38	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
113	39	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
114	39	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
115	39	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
116	40	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
117	40	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
118	40	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
119	41	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
120	41	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
121	41	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
122	42	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
123	42	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
124	42	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
125	43	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
126	43	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
127	43	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
128	44	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
129	44	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
130	44	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
131	45	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
132	45	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
133	45	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
134	46	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
135	46	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
136	46	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
137	47	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
138	47	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
139	47	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
140	48	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
141	48	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
142	48	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
143	49	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
144	49	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
145	49	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
146	50	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
147	50	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
148	50	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
149	51	residente	1	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
150	51	superintendente	2	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
151	51	supervision	3	2026-04-23	\N	Asignación inicial (alta del contrato)	\N	\N	1	2026-06-22 16:50:13.015179+00	\N
\.
...
COPY public.contratos (id, folio, tipo, objeto, contratista, dependencia, monto, plazo_dias, fecha_inicio, fecha_termino, pdf_path, created_by, created_at, datos_juridicos, anticipo_pct, penalizacion, amortizacion, ubicacion, residente_id, superintendente_id, supervision_id, dependencia_id, ciclo_estimacion, pena_convencional_pct, estado, cerrado_en, contratista_empresa_id, supervision_empresa_id) FROM stdin;
52	OP-2026-DEMO-001	Obra pública (precios unitarios)	Rehabilitación de pavimento - tramo demo Sprint 0	Contratista Demo S.A.	Secretaría de Obras Públicas (demo)	1500000.00	120	2026-06-22	2026-10-20	\N	1	2026-06-22 16:50:27.803779+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	vigente	\N	\N	\N
27	saddsa	Obra pública sobre la base de precios unitarios	fsaadfs	Arq. Carlos Contratista Demo	Lic. Diana Dependencia Demo	6931988.00	1500	2026-06-15	2030-07-23	\N	35	2026-06-22 01:11:01.623717+00	{"notaria": "ads", "cargoFirmante": "sad", "poderNotarial": "asd", "cedulaProfesional": "asd", "representanteLegal": "Arq. Carlos Contratista Demo", "firmanteDependencia": "Lic. Diana Dependencia Demo"}	30.00	\N	\N	dfsadfas	35	2	22	4	mensual	\N	vigente	\N	2	9
30	OP-2026-0003	Obra pública sobre la base de precios unitarios	Ampliación del laboratorio de cómputo y cableado estructurado	Ing. Carlos Méndez Rivera	Lic. Diana Herrera Salgado	1060000.00	90	2026-04-23	2026-07-21	\N	1	2026-06-22 16:50:13.015179+00	{"ramo": "Obra pública educativa", "licitacion": "LO-911037999-E12-2026", "fecha_fallo": "2026-01-30"}	30.00	\N	\N	Ciudad Universitaria, Chilpancingo de los Bravo, Guerrero	1	2	3	4	mensual	0.0010	vigente	\N	2	3
31	OP-2026-0004	Obra pública sobre la base de precios unitarios	Construcción de la barda perimetral y caseta de control de acceso	Ing. Carlos Méndez Rivera	Lic. Diana Herrera Salgado	1000000.00	90	2026-04-23	2026-07-21	\N	1	2026-06-22 16:50:13.015179+00	{"ramo": "Obra pública educativa", "licitacion": "LO-911037999-E12-2026", "fecha_fallo": "2026-01-30"}	30.00	\N	\N	Ciudad Universitaria, Chilpancingo de los Bravo, Guerrero	1	2	3	4	mensual	0.0010	vigente	\N	2	3
...
51	OP-2026-0024	Obra pública sobre la base de precios unitarios	Construcción del edificio de posgrado e investigación	Ing. Carlos Méndez Rivera	Lic. Diana Herrera Salgado	1000000.00	90	2026-04-23	2026-07-21	\N	1	2026-06-22 16:50:13.015179+00	{"ramo": "Obra pública educativa", "licitacion": "LO-911037999-E12-2026", "fecha_fallo": "2026-01-30"}	30.00	\N	\N	Ciudad Universitaria, Chilpancingo de los Bravo, Guerrero	1	2	3	4	mensual	0.0010	cerrado	2026-06-22 16:50:13.015179+00	2	3
53	kjahbdskdsa	Obra pública sobre la base de precios unitarios	alsdkjlasd	Ing. Carlos Méndez Rivera	Lic. Diana Dependencia Sur	27552.00	10	2026-06-22	2026-07-01	\N	35	2026-06-22 17:05:53.683791+00	{"notaria": "asdds", "cargoFirmante": "sfa", "poderNotarial": "adssd", "cedulaProfesional": "dsadsa", "representanteLegal": "Ing. Carlos Méndez Rivera", "firmanteDependencia": "Lic. Diana Dependencia Sur"}	30.00	\N	\N	lkjadslsa	35	2	3	12	mensual	\N	vigente	\N	2	3
...
26	OBRA-2026-PRUEBA-FINAL	Obra pública sobre la base de precios unitarios	onstrucción de aula didáctica — campus UAGRO (prueba E2E final)	Arq. Carlos Contratista Demo	Lic. Diana Dependencia Demo	1000000.00	100	2026-01-01	2026-04-10	\N	35	2026-06-21 21:53:40.071664+00	{"notaria": "", "cargoFirmante": "Directora de Obras Públicas", "poderNotarial": "", "cedulaProfesional": "12345678", "representanteLegal": "Arq. Carlos Contratista Demo", "firmanteDependencia": "Lic. Diana Dependencia Demo"}	30.00	\N	\N	Av. Juárez s/n, Chilpancingo, Gro	35	7	3	4	mensual	\N	vigente	2026-06-21 23:35:00.643118+00	2	3
\.
...
5	27	2	CM-002	plazo	art59	[Oficio de soporte: 4] holaaaa	2026-06-24	158772.00	158772.00	1000	1500	0.00	50.00	t	f	4	2026-06-24 06:48:44.45474+00	70	autorizado	2026-06-24 06:49:59.951901+00
6	27	3	45646	programa	art59	[Oficio de soporte: klnkj] lknh	2026-06-24	158772.00	158772.00	1500	1500	0.00	\N	f	f	\N	2026-06-24 07:00:26.138798+00	71	registrado	\N
7	27	4	CM-004	programa	art59	[Oficio de soporte: k] uijhiu	2026-06-24	158772.00	6908988.00	1500	1500	4251.52	\N	t	t	4	2026-06-24 07:31:16.617259+00	72	autorizado	2026-06-24 07:31:36.317833+00
8	27	5	kln	monto	art59	[Oficio de soporte: hkjhkj] kjhnkn	2026-06-24	6908988.00	6931988.00	1500	1500	0.33	\N	f	f	\N	2026-06-24 07:41:05.616902+00	74	registrado	\N
\.
...
COPY public.estimacion_fotos (id, estimacion_id, nombre, descripcion, created_at, mime, tamano, contenido, subido_por, contrato_concepto_id) FROM stdin;
\.
...
38	36	151	1013.0000	0.0000	21.0000
\.
...
COPY public.estimacion_observaciones (id, estimacion_id, seccion, tipo, severidad, descripcion, estado, turnado_a, autor_id, created_at, solventada_en, estimacion_generador_id) FROM stdin;
6	16	generadores	rechazo	mayor	esta mal lo acumulado	abierta	residencia	3	2026-06-21 22:53:18.111122+00	\N	\N
7	16	caratula	rechazo	mayor	mal los conceptos	abierta	contratista	35	2026-06-21 22:54:05.281159+00	\N	\N
8	17	caratula	aclaracion	menor	Turnada a residencia sin observaciones de supervisión.	abierta	residencia	3	2026-06-21 22:59:01.958005+00	\N	\N
9	22	caratula	aclaracion	menor	Revisada por supervisión y autorizada por la residencia.	solventada	residencia	3	2026-06-22 16:50:13.015179+00	\N	\N
10	25	generadores	rechazo	mayor	Los números generadores no coinciden con lo ejecutado; se devuelve para corrección.	abierta	contratista	1	2026-06-22 16:50:13.015179+00	\N	\N
11	27	caratula	aclaracion	menor	Revisada por supervisión y autorizada por la residencia.	solventada	residencia	3	2026-06-22 16:50:13.015179+00	\N	\N
12	29	caratula	aclaracion	menor	Revisada por supervisión y autorizada por la residencia.	solventada	residencia	3	2026-06-22 16:50:13.015179+00	\N	\N
13	30	caratula	aclaracion	menor	Revisada por supervisión y autorizada por la residencia.	solventada	residencia	3	2026-06-22 16:50:13.015179+00	\N	\N
14	35	caratula	aclaracion	menor	Turnada a residencia sin observaciones de supervisión.	abierta	residencia	22	2026-06-22 22:31:17.014127+00	\N	\N
\.
...
34	53	1	2026-06-22	2026-07-01	rechazada	30.00	27552.00	8265.60	137.76	0.00	19148.64	2	2026-06-22 17:09:26.609831+00	2026-06-22 17:10:41.687194+00	2	\N	0.00	100.0000	0.0000
36	53	2	2026-06-22	2026-06-23	integrada	30.00	21273.00	6381.90	106.37	0.00	14784.73	2	2026-06-24 07:50:25.706312+00	\N	\N	\N	0.00	77.2104	0.0000
\.
...
164	77	76	524.000	2026-06-24 07:41:05.616902+00
165	78	77	524.000	2026-06-24 07:41:05.616902+00
166	152	78	216.000	2026-06-24 07:41:05.616902+00
167	153	78	500.000	2026-06-24 07:41:05.616902+00
\.
...
3	27	2	3	158772.00	1000	f	2026-06-22 01:13:14.898427+00	2026-06-24 07:00:26.138798+00
6	27	3	6	158772.00	1500	f	2026-06-24 07:00:26.138798+00	2026-06-24 07:31:16.617259+00
7	27	4	7	6908988.00	1500	f	2026-06-24 07:31:16.617259+00	2026-06-24 07:41:05.616902+00
8	27	5	8	6931988.00	1500	t	2026-06-24 07:41:05.616902+00	\N
\.
...
13	6	dsa	1	2026-06-15	2026-07-14	524.000
14	6	dsf	2	2026-07-15	2026-08-14	524.000
15	7	dsa	1	2026-06-15	2026-06-20	524.000
16	7	dsf	2	2026-06-21	2026-06-23	524.000
17	7	jhb	3	2026-08-15	2026-09-12	216.000
18	8	dsa	1	2026-06-15	2026-06-20	524.000
19	8	dsf	2	2026-06-21	2026-06-23	524.000
20	8	jhb	3	2026-08-15	2026-09-12	216.000
21	8	a01	3	2026-08-15	2026-09-12	500.000
\.
...
13	6	dsa	ads	m³	524.000	45.0000	1
14	6	dsf	hgfh	cm	524.000	258.0000	2
15	7	dsa	ads	m³	524.000	45.0000	1
16	7	dsf	hgfh	cm	524.000	258.0000	2
17	7	jhb	kjnkl	cm3	216.000	31251.0000	3
18	8	a01	ads	m3	500.000	46.0000	4
19	8	dsa	ads	m³	524.000	45.0000	1
20	8	dsf	hgfh	cm	524.000	258.0000	2
21	8	jhb	kjnkl	cm3	216.000	31251.0000	3
\.
...
COPY public.usuarios (id, nombre, email, password_hash, rol, created_at, estado, rol_solicitado, aprobado_por, aprobado_en, empresa_id, token_version) FROM stdin;
5	Profesor (Sistemas)	csilvasa@ipn.mx	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	residente	2026-06-21 19:31:25.21579+00	activo	\N	\N	\N	1	0
7	Ing. Marco Superintendente 2	super2.demo@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	contratista	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	2	0
8	Ing. Laura Superintendente 3	super3.demo@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	contratista	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	2	0
9	Ing. Pedro Patito	patito1@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	contratista	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	5	0
10	Ing. Paola Patito	patito2@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	contratista	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	5	0
11	Ing. Raúl Residente 2	residente2.demo@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	residente	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	1	0
12	Lic. Diana Dependencia Sur	dependencia.sur@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	dependencia	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	4	0
13	Ing. Iván Residente Sur	residente.sur@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	residente	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	4	0
14	Arq. Sergio Supervisión 2	superv2.demo@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	supervision	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	3	0
15	Arq. Silvia Supervisión Sur	superv.sur@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	supervision	2026-06-21 19:32:38.277926+00	activo	\N	\N	\N	6	0
16	Lic. Norma Dependencia Norte	dep2@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	dependencia	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	7	0
17	Ing. Néstor Residente Norte	residente.norte@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	residente	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	7	0
18	C.P. Nadia Finanzas Norte	finanzas.norte@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	finanzas	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	7	0
19	C.P. Susana Finanzas Sur	finanzas.sur@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	finanzas	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	4	0
20	Ing. Patricia Pacífico	pacifico1@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	contratista	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	8	0
21	Ing. Pablo Pacífico	pacifico2@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	contratista	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	8	0
78	mike candelario suarez	mike@gmail.com	$2a$10$u/VSngbmJqrgEijHIG/50OvRZcNjIWCUpFUjbbDUR4ALQC7bOc9ta	\N	2026-06-22 16:09:39.00326+00	pendiente	residente	\N	\N	13	0
79	adssa adsads	dsadsa@gmail.com	$2a$10$/zsNZRdllJAnSmSwyfd0ueqNjEMW73eUeD08CM1GjzHTLU9e1k0YS	\N	2026-06-22 16:18:55.186968+00	pendiente	contratista	\N	\N	14	0
22	Arq. Nadia Supervisión Norte	superv.norte@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	supervision	2026-06-21 19:32:39.401234+00	activo	\N	\N	\N	9	3
6	C.P. Fernando Ríos Aguilar	finanzas@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	finanzas	2026-06-21 19:31:25.21579+00	activo	\N	\N	\N	1	0
35	ivan Lopez Garcia	chocovan392@gmail.com	$2a$10$.a6SBmfRmEzuLYD774e.dOfXvwxp6OQ2hZJsfF.3A/MGzKtt9Vsva	residente	2026-06-21 21:34:00.104826+00	activo	residente	4	2026-06-21 21:34:52.63847+00	11	9
2	Ing. Carlos Méndez Rivera	contratista@sigecop.test	$2a$10$h7eLpWBwF5O3smp/egT3wupSylCFRXlwQQIeHbnvCdJOmM5xAhdgK	contratista	2026-06-21 19:31:25.21579+00	activo	\N	\N	\N	2	8
4	Lic. Diana Herrera Salgado	dependencia@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	dependencia	2026-06-21 19:31:25.21579+00	activo	\N	\N	\N	1	7
3	Arq. Mónica Vázquez Lara	supervision@sigecop.test	$2a$10$zpUoEVcL3IZhAtpS4kexoemneAaX93X7.A3kbLPYOBwgw51eZC33e	supervision	2026-06-21 19:31:25.21579+00	activo	\N	\N	\N	3	3
1	Ing. Roberto Salazar Gómez	residente@sigecop.test	$2a$10$n4rhCkjJeeKM0GPpL8lUbenEoUFhckkQRHnui1SYG6z6/PbM.7qBy	residente	2026-06-21 19:31:25.21579+00	activo	\N	\N	\N	1	1
\.
...
--
-- Name: avance_fotos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.avance_fotos_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.bitacora_notas_id_seq', 75, true);


--
-- Name: cobro_soportes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.cobro_soportes_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.concepto_avance_id_seq', 53, true);
...
SELECT pg_catalog.setval('public.contrato_conceptos_id_seq', 153, true);
...
SELECT pg_catalog.setval('public.contrato_documentos_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.convenios_modificatorios_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.estimacion_generadores_id_seq', 38, true);
...
SELECT pg_catalog.setval('public.estimaciones_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.programa_obra_id_seq', 167, true);
...
SELECT pg_catalog.setval('public.programa_version_celda_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.programa_version_concepto_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.programa_version_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.usuarios_id_seq', 139, true);
...
--
-- Name: avance_fotos avance_fotos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.avance_fotos
    ADD CONSTRAINT avance_fotos_pkey PRIMARY KEY (id);
...
--
-- Name: cobro_soportes cobro_soportes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cobro_soportes
    ADD CONSTRAINT cobro_soportes_pkey PRIMARY KEY (id);
...
--
-- Name: idx_avance_fotos_avance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_avance_fotos_avance ON public.avance_fotos USING btree (avance_id);
...
--
-- Name: idx_cobro_soportes_estimacion; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cobro_soportes_estimacion ON public.cobro_soportes USING btree (estimacion_id);
...
--
-- Name: avance_fotos avance_fotos_avance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.avance_fotos
    ADD CONSTRAINT avance_fotos_avance_id_fkey FOREIGN KEY (avance_id) REFERENCES public.concepto_avance(id) ON DELETE CASCADE;


--
-- Name: avance_fotos avance_fotos_subido_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.avance_fotos
    ADD CONSTRAINT avance_fotos_subido_por_fkey FOREIGN KEY (subido_por) REFERENCES public.usuarios(id);
...
--
-- Name: cobro_soportes cobro_soportes_estimacion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cobro_soportes
    ADD CONSTRAINT cobro_soportes_estimacion_id_fkey FOREIGN KEY (estimacion_id) REFERENCES public.estimaciones(id) ON DELETE CASCADE;


--
-- Name: cobro_soportes cobro_soportes_subido_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cobro_soportes
    ADD CONSTRAINT cobro_soportes_subido_por_fkey FOREIGN KEY (subido_por) REFERENCES public.usuarios(id);
...
--
-- Name: contrato_roster contrato_roster_empresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contrato_roster
    ADD CONSTRAINT contrato_roster_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id);
...
--
-- Name: contratos contratos_contratista_empresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contratos
    ADD CONSTRAINT contratos_contratista_empresa_id_fkey FOREIGN KEY (contratista_empresa_id) REFERENCES public.empresas(id);
...
--
-- Name: contratos contratos_supervision_empresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contratos
    ADD CONSTRAINT contratos_supervision_empresa_id_fkey FOREIGN KEY (supervision_empresa_id) REFERENCES public.empresas(id);
...
--
-- Name: estimacion_fotos estimacion_fotos_contrato_concepto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimacion_fotos
    ADD CONSTRAINT estimacion_fotos_contrato_concepto_id_fkey FOREIGN KEY (contrato_concepto_id) REFERENCES public.contrato_conceptos(id) ON DELETE SET NULL;
...
--
-- Name: estimacion_observaciones estimacion_observaciones_estimacion_generador_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimacion_observaciones
    ADD CONSTRAINT estimacion_observaciones_estimacion_generador_id_fkey FOREIGN KEY (estimacion_generador_id) REFERENCES public.estimacion_generadores(id) ON DELETE SET NULL;
...
\unrestrict k6m4K6YcPZhR3zBmd5EX762HvB0hqHX7j3705h7R4BFfJrUtlpiuQvn8tOahXdW
